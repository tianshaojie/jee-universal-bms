...
/**
 * jquery.easyui.min.js修改列表，方便升级使用
 */

// window默认项: resizable:false,modal:true,collapsible:false,minimizable:false,maximizable:false,
...
// datagrid默认项: fitColumns:true,rownumbers: true,
...
// datagrid默认项: layout:["list","sep","first","prev","sep","links","sep","next","last","sep","refresh"]  (manual-links)
// $.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","links","sep","next","last","sep","refresh"],onSelectPage:function(_c7,_c8){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:true,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:true,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_5ed(true),mouseout:_5ed(false),click:_5f5,dblclick:_5ff,contextmenu:_603},rowStyler:function(_78c,_78d){
